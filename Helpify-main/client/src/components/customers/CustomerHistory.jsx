    ...
    <>
      ...
      <div className="bg-[#fff] p-1 sm:p-6 md:p-8 lg:p-10 space-y-4">
        {orders.map((order) => (
          <div
            key={order.id}
            className="rounded-mds p-4 flex"
            style={{
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="text-[6px] sm:text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px] font-medium">
                ...
                <div className="flex gap-4">
                  <button className="bg-[#4BAAD8] text-[white] p-2 sm:p-2 text-[8px] sm:text-[12px] md:text-[14px] lg:text-[16px] rounded-md">
                    Pending
                  </button>
                  <button className="bg-[#FF4141] text-[white] p-2 sm:p-2 text-[8px] sm:text-[12px] md:text-[14px] lg:text-[16px] rounded-md">
                    Cancel Order
                  </button>
                </div>
              </div>
